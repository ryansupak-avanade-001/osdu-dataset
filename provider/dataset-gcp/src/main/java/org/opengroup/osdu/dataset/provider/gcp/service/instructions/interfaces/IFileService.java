...
public interface IFileService {
	...
	GetDatasetStorageInstructionsResponse getCollectionUploadInstructions();

	GetDatasetRetrievalInstructionsResponse getFileRetrievalInstructions(
		GetDatasetRegistryRequest getDatasetRegistryRequest);

	GetDatasetRetrievalInstructionsResponse getCollectionRetrievalInstructions(
		GetDatasetRegistryRequest getDatasetRegistryRequest);
